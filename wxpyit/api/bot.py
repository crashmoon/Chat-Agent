...
from wxpyit import itchat

from ..api.chats import MP, Chat, Chats, Friend, Group, User
from ..api.consts import SYSTEM
from ..api.messages import Message, MessageConfig, Messages, Registered
from ..utils import (PuidMap, enhance_connection, enhance_webwx_request,
                     ensure_list, get_user_name, handle_response,
...
class Bot(object):
    ...
    def groups(self, update=False, contact_only=True):
